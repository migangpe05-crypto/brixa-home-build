...
export default function DROSection() {
  ...
  return (
    <section
      id="dro"
      aria-labelledby="dro-heading"
      className="bg-[#111111] py-24 px-4 overflow-hidden"
    >
      <div
        ref={headerRef}
      ...
      >
        ...
        >
          DRO —{' '}
          <span className="text-[#C00000]">Dirección Responsable</span>
          <br />
          de Obra
        </h2>
        <p className="text-[#8A8A8A] text-lg max-w-2xl mx-auto leading-relaxed">
          Supervisión técnica, legal y profesional para garantizar la correcta ejecución de cada proyecto.
        </p>
      ...
      <div
        ref={bannerRef}
        className={`max-w-5xl mx-auto mt-16 transition-all duration-700 ${bannerIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
        style={{ transitionDelay: bannerIn ? '200ms' : '0ms' }}
      >
        <div className="relative rounded-2xl overflow-hidden border border-[#C00000]/30">
          ...
          <div className="relative px-10 md:px-14 py-10 flex flex-col md:flex-row items-start md:items-center gap-6">
            ...
            <p className="text-white/90 text-base md:text-lg leading-relaxed font-light">
              En <span className="font-bold text-white">BRIXA</span>, cada proyecto
